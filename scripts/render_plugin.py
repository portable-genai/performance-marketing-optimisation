...
def build_spec() -> PluginSpec:
    ...
    from performance_marketing.adapters.gcp.mcp_tool_catalog import McpToolCatalogAdapter
    from performance_marketing.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/performance-marketing-optimisation",
        ...
        servers={
            "performance-marketing-optimisation": StdioServer(
                command="python",
                args=("-m", "performance_marketing.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
