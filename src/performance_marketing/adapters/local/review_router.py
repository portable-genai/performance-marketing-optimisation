...
Exercises the R8 routing path offline: an escalated performance report is converted to a review
and enqueued (the same transactional outbox the platform adapter flushes to Hrz7), so tests and
