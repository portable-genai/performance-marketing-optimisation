...
Primary GCP adapters: an **A2A AgentCard** published at ``/.well-known/agent-card.json``
(with a ``platform`` client to the shared agent registry), and a governed,
least-privilege **MCP** tool catalog.
"""
