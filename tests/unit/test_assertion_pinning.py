...
from performance_marketing.adapters.gcp.iap_identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("performance_marketing.adapters.gcp.iap_identity")
